  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-muted-foreground" aria-describedby="dashboard-title">
                Welcome back, {user.name || user.email}
              </p>
            </div>
            <div className="flex items-center gap-4" role="group" aria-label="Admin actions">
              <Badge variant="default" aria-label="Current user role: Admin">
                <Shield className="h-3 w-3 mr-1" aria-hidden="true" />
                Admin
              </Badge>
              <Link href="/">
                <Button variant="outline" size="sm" aria-label="View public website">
                  View Site
                </Button>
              </Link>
            </div>
      ...
      <main className="container mx-auto px-4 py-8" id="main-content" role="main">
        ...
        >
          <TabsList className="grid w-full grid-cols-5" role="tablist" aria-label="Dashboard navigation">
            <TabsTrigger value="overview" aria-controls="overview-panel">Overview</TabsTrigger>
            <TabsTrigger value="analytics" aria-controls="analytics-panel">Analytics</TabsTrigger>
            <TabsTrigger value="users" aria-controls="users-panel">Users</TabsTrigger>
            <TabsTrigger value="cities" aria-controls="cities-panel">Cities</TabsTrigger>
            <TabsTrigger value="bulk-upload" aria-controls="bulk-upload-panel">Bulk Upload</TabsTrigger>
          </TabsList>
          ...
          >
            ...
            <section aria-labelledby="stats-heading">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4" role="group" aria-label="Key metrics">
                <Card role="article" aria-labelledby="total-users-stat">
                  <CardContent className="p-4">
                    <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-muted-foreground" id="total-users-stat">
                        Total Users
                      </p>
                      <p className="text-2xl font-bold" aria-describedby="total-users-stat">
              ...
              <Card role="article" aria-labelledby="total-cities-stat">
                <CardContent className="p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-muted-foreground" id="total-cities-stat">
                        Total Cities
                      </p>
                      <p className="text-2xl font-bold" aria-describedby="total-cities-stat">
              ...
              <Card role="article" aria-labelledby="total-reviews-stat">
                <CardContent className="p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-muted-foreground" id="total-reviews-stat">
                        Total Reviews
                      </p>
                      <p className="text-2xl font-bold" aria-describedby="total-reviews-stat">
                        {stats.overview.totalReviews.toLocaleString()}
                      </p>
                    </div>
                    <MessageSquare className="h-8 w-8 text-purple-500" aria-hidden="true" />
                  </div>
                </CardContent>
              </Card>
              ...
              <Card role="article" aria-labelledby="average-rating-stat">
                <CardContent className="p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-muted-foreground" id="average-rating-stat">
                        Average Rating
                      </p>
                      <p className="text-2xl font-bold" aria-describedby="average-rating-stat">
